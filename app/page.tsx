...
export const metadata: Metadata = {
  title: 'Tiger 365 ID – Get Your Online Cricket Gaming ID | Tiger365',
  description:
    'Tiger365 ID is your trusted online cricket gaming ID provider. Get instant access to premium sports gaming, live cricket, casino games, and Aviator with 24/7 support. INR accepted.',
  alternates: {
    canonical: '/',
  },
  openGraph: {
