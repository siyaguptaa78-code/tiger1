        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <a
              ...
              className="btn-orange inline-flex items-center gap-2 text-white font-bold px-6 py-3 rounded-full text-sm uppercase tracking-wider"
            >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-gray-600 hover:text-orange-500 text-sm transition-colors duration-300 flex items-center gap-2 group"
                  >
                    <span className="w-0 group-hover:w-3 h-px bg-orange-500 transition-all duration-300"></span>
                    {link.label}
                  </a>
                </li>
              ))}
