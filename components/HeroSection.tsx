  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 left-0 w-64 h-64 bg-orange-600/5 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-orange-500/3 rounded-full blur-3xl"></div>
        {/* Grid pattern */}
        <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="animate-on-scroll opacity-0 translate-y-8 transition-all duration-700">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-500/10 border border-orange-500/30 text-orange-400 text-sm font-medium">
            ...
            <div className="animate-on-scroll opacity-0 translate-y-8 transition-all duration-700 delay-100">
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black leading-tight">
                <span className="text-orange-500 orange-glow-text">Tiger</span>
            ...
            <div className="animate-on-scroll opacity-0 translate-y-8 transition-all duration-700 delay-400">
              <div className="flex flex-wrap gap-4">
                <a
                  ...
                  className="btn-orange flex items-center gap-3 text-white font-bold px-8 py-4 rounded-full text-lg uppercase tracking-wider animate-pulse-orange"
                >
                  {/* WhatsApp Icon */}
          ...
          <div className="flex justify-center lg:justify-end animate-on-scroll opacity-0 translate-y-8 transition-all duration-700 delay-300">
            <div className="relative">
              {/* Glow behind phone */}
              <div className="absolute inset-0 bg-orange-500/20 rounded-3xl blur-3xl scale-110"></div>

              {/* Phone frame */}
              <div className="relative w-72 sm:w-80 animate-float">
                <div className="relative bg-gradient-to-b from-gray-900 to-black rounded-[2.5rem] border-2 border-orange-500/30 shadow-2xl overflow-hidden p-2">
                  {/* Phone notch */}
                  <div className="absolute top-4 left-1/2 -translate-x-1/2 w-24 h-6 bg-black rounded-full z-10"></div>

                  {/* App content mockup */}
                  <div className="bg-gradient-to-b from-orange-950 to-gray-950 rounded-[2rem] overflow-hidden min-h-[600px]">
                    {/* App header */}
                    ...
                    {/* Live match banner */}
                    <div className="m-3 bg-orange-500/20 border border-orange-500/30 rounded-xl p-3">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-center">
                          ...
                          <div className="text-orange-400 font-black text-lg">186/4</div>
                          <div className="text-gray-400 text-xs">18.3 ov</div>
                        </div>
                        <div className="text-orange-500 font-bold text-sm">VS</div>
                        <div className="text-center">
                      ...
                      {[
                        ...
                        <div key={bet.team} className="flex items-center justify-between bg-gray-900/50 rounded-lg px-3 py-2 border border-gray-800">
                          ...
                          <div className="flex items-center gap-2">
                            {bet.hot && <span className="text-xs bg-orange-500 text-white px-1.5 py-0.5 rounded">HOT</span>}
                            <span className="text-orange-400 font-bold">{bet.odds}</span>
                          </div>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gray-950 border-t border-gray-800 flex justify-around py-3 px-6">
                      {['🏠', '🏏', '⚽', '🎮', '👤'].map((icon, i) => (
                        <span key={i} className={`text-xl ${i === 1 ? 'text-orange-500' : 'text-gray-600'}`}>{icon}</span>
                      ))}
                    </div>
                  </div>
                </div>
                ...
                {/* Floating badges */}
                <div className="absolute -right-8 top-1/4 bg-orange-500 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg">
                  ⚡ Live Odds
                </div>
