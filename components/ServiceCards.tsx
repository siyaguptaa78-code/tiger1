      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl sm:text-5xl font-black text-white">
            Why <span className="text-orange-500">Tiger365?</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {serviceCards.map((card) => (
            <div
              ...
              className="group relative bg-[#1a1a1a] border border-orange-500/20 hover:border-orange-500/60 rounded-2xl p-8 transition-all duration-400 hover:shadow-2xl hover:shadow-orange-500/15 hover:-translate-y-2 flex flex-col"
            >
              {/* Top accent */}
              <div className="absolute top-0 left-8 right-8 h-px bg-gradient-to-r from-transparent via-orange-500 to-transparent opacity-50"></div>
              ...
              <div className="inline-flex items-center gap-2 bg-orange-500/10 border border-orange-500/20 rounded-full px-3 py-1 mb-6 w-fit">
                ...
                <span className="text-orange-400 text-xs font-bold">{card.badge}</span>
              </div>
              ...
              {/* Title */}
              <h3 className="text-2xl font-black text-white mb-4 group-hover:text-orange-50 transition-colors duration-300">
                {card.title}
              </h3>
              ...
              <a
                ...
                className="btn-orange flex items-center justify-center gap-2 text-white font-bold py-3 px-6 rounded-full text-sm uppercase tracking-wider w-full"
              >
              ...
              <div className="absolute -bottom-px left-8 right-8 h-px bg-gradient-to-r from-transparent via-orange-500/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </div>
          ))}
        </div>
      </div>
