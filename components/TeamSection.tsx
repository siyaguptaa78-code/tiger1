    ...
    <section id="team" className="py-20 relative overflow-hidden bg-[#0d0d0d]">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="inline-flex items-center gap-3 mb-6">
          ...
          <span className="text-orange-500 font-bold uppercase tracking-[0.3em] text-sm">Team Members</span>
          <div className="w-8 h-px bg-orange-500"></div>
        </div>
        ...
        <div className="flex justify-center -space-x-4 mb-12">
          {['👨‍💼', '👩‍💼', '👨‍💻', '👩‍💻', '👨‍🔧', '👩‍🔧'].map((emoji, i) => (
            <div
              key={i}
              className="relative w-14 h-14 rounded-full border-2 border-orange-500/40 bg-gradient-to-br from-orange-900 to-gray-900 flex items-center justify-center text-2xl hover:scale-110 transition-transform duration-300 hover:z-10"
              style={{ zIndex: i }}
            >
              {emoji}
            </div>
          ...
          <div
            className="relative w-14 h-14 rounded-full border-2 border-orange-500 bg-orange-500 flex items-center justify-center text-white text-xs font-bold"
            style={{ zIndex: 7 }}
          >
            +50
          </div>
        ...
        {/* Big play more text */}
        <div className="py-12 px-8 bg-gradient-to-r from-orange-950/50 via-black to-orange-950/50 rounded-3xl border border-orange-500/20 mb-10">
          ...
          <div className="text-5xl sm:text-7xl lg:text-8xl font-black leading-none mt-2">
            ...
            <span className="text-orange-400">MORE!</span>
          </div>
        ...
        <a
          ...
          className="btn-orange inline-flex items-center gap-3 text-white font-bold px-10 py-5 rounded-full text-xl uppercase tracking-wider"
        >
